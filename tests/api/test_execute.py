...
class TestExecute:
    ...
    def test_execute_success(self, client, golden_spec_passing, csv_path):
    ...
    def test_execute_no_table_paths(self, client, golden_spec_passing, csv_path):
    ...
    def test_execute_invalid_spec(self, client, csv_path):
    ...
    def test_execute_success_no_pipeline_error(self, client, golden_spec_passing, csv_path):
    ...
    def test_execute_rich_success(self, client, golden_spec_passing, csv_path):
