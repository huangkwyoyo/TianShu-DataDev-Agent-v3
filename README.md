...
- **Phase 6–8 设计已完成**——完整设计方案 + 实施计划已产出，详见 `docs/superpowers/specs/2026-07-03-spark-first-phase-6-8-design.md` 和 `docs/superpowers/specs/2026-07-03-spark-first-phase-6-8-implementation-plan.md`。
- 下一阶段：Phase 0（前置迁移）→ Phase 6A — 受控 PySpark DSL 基础编译闭环。
...
| 6 | `phase-6-controlled-pyspark-dsl.md` | 📋 设计完成，待实施 |
| 7 | `phase-7-sql-spark-cross-validation.md` | 📋 设计完成，待实施 |
| 8 | `phase-8-spark-first-orchestration-hardening.md` | 📋 设计完成，待实施 |

**实施顺序**：Phase 0（SparkReadStep 迁移）→ 6A → 7A → 6B → 7B → 6C → 7C → 8
