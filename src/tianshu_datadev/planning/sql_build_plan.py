    ...
    def _build_plans_from_compute_steps(
        ...
        for idx, cs in enumerate(sorted_steps):
            ...
            if len(sources) == 1 and sources[0] == "input":
                ...
                src = sources[0]
                temp_ref = f"_temp_{chain_id}_{src}"
            ...
            if cs.case_when and cs.case_when.branches:
                ...
                if isinstance(cs.source, list) and len(cs.source) > 0:
                    cw_table_ref = f"_temp_{chain_id}_{cs.source[0]}"
            ...
            if is_final:
                ...
                proj_table_ref = ""
                if isinstance(cs.source, list) and len(cs.source) > 0:
                    proj_table_ref = f"_temp_{chain_id}_{cs.source[0]}"
    ...
    def build_multi(
        ...
        for idx, candidate in enumerate(chain):
            ...
            if idx == 0:
                ...
                left_source = f"_temp_{chain_id}_{idx - 1}"
